  ...
  return (
    ...
    bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen'>
      ...
      md:leading-[56px] font-bold md:font-extrabold max-w-xl mt-4'>
        Discover Your Perfect Getaway Destination</h1>
      <p className='max-w-130 mt-2 text-sm md:text-base'>Unparrallelled comfort and luxury at your fingertips. 
        at the world's most beautiful Hotels. start your journey today</p>
